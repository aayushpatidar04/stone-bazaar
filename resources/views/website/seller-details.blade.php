        ...
        <section class="team-details product-page--carousel" style="padding: 50px 0;">
            <div class="container-fluid">
                            ...
                            <a href="{{ Route('product-details', ['id' => $product->id]) }}">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='000ms'>
                                    <div class="product__item__image">
                                        <img src="{{ $displayImage['image'] }}" class="fixed-img2" alt="$product->name">
                                    </div><!-- /.product-image -->
                                </div><!-- /.product-item -->
                ...
                <div class="text-center mt-2">
                    <a href="{{ Route('seller-products', ['id' => $seller->id]) }}" class="floens-btn"><span>View
    ...
    @if ($sellerGallery->count() > 0)
        <section class="gallery-one" style="padding: 50px 0;">
            <div class="container">
                ...
                <div class="text-center mt-2">
                    <a href="{{ Route('seller-gallery', ['id' => $seller->id]) }}" class="floens-btn"><span>View
                            All</span><i class="icon-right-arrow"></i></a>
                </div>
            </div><!-- /.container-fluid -->
        </section>
    ...
    <section class="contact-one contact-one--team section-space">
        <div class="container">
            <div class="row gutter-y-40">
                ...
                <div class="col-lg-6">
                    <form method="POST" action="{{ Route('save-seller-enquiry') }}" enctype="multipart/form-data"
                        ...
                        <div class="form-one__group">
                            ...
                            <div class="form-one__control form-one__control--full">
                                <select name="project_type" class="form-select" style="background: transparent; color:white;" required>
                                    ...
                                    <option style="color: black;" value="Home">Home</option>
                                    <option style="color: black;" value="Hotel">Hotel</option>
                            ...
                            <div class="form-one__control form-one__control--full">
                                <select name="stone_requirement" class="form-select" style="background: transparent; color:white;" required>
                                    <option style="color: black;" disabled selected>Select Stone Type</option>
                                    <option style="color: black;" value="Italian Marble">Italian Marble</option>
                                    <option style="color: black;" value="Indian Granite">Indian Granite</option>
                                    <option style="color: black;" value="Onyx Marble">Onyx Marble</option>
                                    <option style="color: black;" value="Travertine">Travertine</option>
                                    <option style="color: black;" value="Sandstone">Sandstone</option>
                                    <option style="color: black;" value="Quartzite">Quartzite</option>
                                    <option style="color: black;" value="Other">Other</option>
                                </select>
                            </div>
                            ...
                            <div class="form-one__control form-one__control--full">
                                <input type="text" name="quantity"
                                    placeholder="Quantity Required e.g. 1000 sq.ft / 10 slabs" required>
                            </div>

                            <div class="form-one__control form-one__control--full">
                                <input type="text" name="budget_range"
                                    placeholder="Budget Range e.g. ₹50,000 – 1,00,000" required>
                            </div>

                            <div class="form-one__control form-one__control--full">
                                <input type="text" name="color_design"
                                    placeholder="Required Color / Design e.g. White, Grey" required>
                            </div>

                            <div class="form-one__control form-one__control--full">
                                <textarea name="delivery_location" placeholder="Delivery Location" required></textarea>
                            </div>

                            <div class="form-one__control form-one__control--full">
                                <select name="urgency" class="form-select" style="background: transparent; color:white;" required>
                                    <option style="color: black;" disabled selected>Requirement Urgency</option>
                                    <option style="color: black;" value="Immediate">Immediate</option>
                                    <option style="color: black;" value="Within 1 Month">Within 1 Month</option>
                                    <option style="color: black;" value="Flexible">Flexible</option>
                                </select>
                            </div>

                            <div class="form-one__control form-one__control--full">
                                <textarea name="message" placeholder="Message / Additional Details"></textarea>
                            </div>

                            <div class="form-one__control form-one__control--full">
                                <input type="file" name="reference_image" accept="image/png,image/jpeg">
                            </div>
