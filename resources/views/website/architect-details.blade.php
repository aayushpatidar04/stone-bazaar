    ...
    <section class="page-header">
        ...
        <div class="container">
            <img src="{{ $architect->architect->logo ?? asset('assets/images/logo.png') }}"
                alt="{{ $architect->architect->firm_name ?? $architect->name }}" style="max-width: 200px; height: auto;">
        </div><!-- /.container -->
    </section><!-- /.page-header -->
                ...
                <div class="team-details__content">
                    <div class="team-details__top">
                        <div class="team-details__identity">
                            <h4 class="team-details__name">{{ $architect->architect->firm_name ?? $architect->name }}</h4>
                            <!-- /.team-details__name -->
                    ...
                    <img src="{{ $architect->architect->logo }}" alt="{{ $architect->name }}" style="max-width: 80px; height:auto;">
    ...
    <section class="contact-one contact-one--team section-space">
        <div class="container">
            <div class="row gutter-y-40">
                ...
                <div class="col-lg-6">
                    <form method="POST" action="{{ Route('save-architect-enquiry') }}" class="contact-one__form contact-form-validated form-one wow fadeInUp"
                        data-wow-duration="1500ms" data-wow-delay="200ms" action="#">
                        @csrf
                        <input type="hidden" name="user_id" value="{{ $architect->id }}" required>
