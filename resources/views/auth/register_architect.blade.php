...
<body class="multi-step-sign-up">
    ...
    <form id="msform" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
        ...
        <fieldset>
            ...
            <input type="hidden" name="role" value="Architect"/>
        ...
        <fieldset>
            ...
            <div class="input-group">
                <input type="text" class="form-control" name="firm_name" value="{{ old('firm_name') }}"
                    placeholder="Firm/Studio Name" required />
            </div>
            <div class="input-group">
                <input type="text" class="form-control" name="specialization" value="{{ old('specilization') }}"
                    placeholder="Specialization" required />
            </div>
            <div class="mb-3">
                <input type="text" placeholder="Years of Experience" pattern="\d+" title="Please enter digits only" class="form-control" name="years_of_experience" value="{{ old('years_of_experience') }}" required/>
            </div>
            <div class="mb-3">
