...
//         '<a href="javascript:void(0)" target="_blank" class="btn btn-facebook soc-icon m-b-20"><i class="feather icon-facebook"></i></a>' +
//         '<a href="javascript:void(0)" target="_blank" class="btn btn-twitter soc-icon m-l-20 m-b-20"><i class="feather icon-twitter"></i></a>' +
//     '</li>' +
// '</ul>'+
// '');
