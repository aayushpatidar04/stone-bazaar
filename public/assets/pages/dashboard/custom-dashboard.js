...
$(document).ready(function() {
    var canvas = document.getElementById('update-chart-1');
    if (canvas) {
    ...
    var canvas = document.getElementById('update-chart-2');
    if (canvas) {
        var ctx = canvas.getContext("2d");
        var myChart = new Chart(ctx, {
            type: 'bar',
    ...
    var canvas = document.getElementById('update-chart-3');
    if (canvas) {
        var ctx = canvas.getContext("2d");
        var myChart = new Chart(ctx, {
            type: 'bar',
    ...
    var canvas = document.getElementById('update-chart-4');
    if (canvas) {
        var ctx = canvas.getContext("2d");
        var myChart = new Chart(ctx, {
            type: 'bar',
    ...
    var canvas = document.getElementById('app-sale1');
    if (canvas) {
        var ctx = canvas.getContext("2d");
        var myChart = new Chart(ctx, {
            type: 'line',
    ...
    var canvas = document.getElementById('app-sale2');
    if (canvas) {
        var ctx = canvas.getContext("2d");
        var myChart = new Chart(ctx, {
            type: 'line',
    ...
    var canvas = document.getElementById('app-sale3');
    if (canvas) {
        var ctx = canvas.getContext("2d");
        var myChart = new Chart(ctx, {
            type: 'line',
    ...
    var canvas = document.getElementById('app-sale4');
    if (canvas) {
        var ctx = canvas.getContext("2d");
        var myChart = new Chart(ctx, {
            type: 'line',
